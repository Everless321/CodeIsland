...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        // MCP / Servers
        "servers": "Servers",
        "server_access_request": "Server Access Request",
        "server_delete_request": "Server Delete Request",
        "approve": "APPROVE",
        "select_server_hint": "Select a server, or click + to add",
    ...
    private static let zh: [String: String] = [
        ...
        // MCP / Servers
        "servers": "服务器",
        "server_access_request": "服务器访问请求",
        "server_delete_request": "服务器删除请求",
        "approve": "批准",
        "select_server_hint": "选择一个服务器，或点击 + 添加",
        "basic_info": "基本信息",
        "server_name": "名称",
        "host": "主机",
        "port": "端口",
